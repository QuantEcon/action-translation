...
export const LANGUAGE_CONFIGS: Record<string, LanguageConfig> = {
  ...
  ml: {
    ...
    // Held for the editor's answers on ml#22: the rule-2 boundary (which
    // ordinary words stay English), provide, prefer, draw, the plural form of
    // retained nouns, and the comma between single-word -ഉം pairs.
    additionalRules: [
