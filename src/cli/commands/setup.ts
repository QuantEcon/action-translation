...
export async function runSetup(
  ...
  if (!options.sourceWorkflow) {
    ...
    console.log(`     translate setup --source ${options.source} --target-language ${options.targetLanguage} --source-workflow /path/to/source/.github/workflows/sync-translations.yml`);
    console.log(`     Or copy the template from the documentation.`);
  }
  console.log('');
