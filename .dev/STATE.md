...
- **ml round 3 encoded on `ml-round3-v06` (2026-09-18, PR open — not yet released)** — the
  ...
  from comma density (0.56 → 0.72 vs his 0.82); exemplars show no measurable closeness
  effect. Editor's open questions: lecture-python-programming.ml#22 (none blocks a release).
