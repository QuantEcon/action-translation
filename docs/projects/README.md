...
- [ARCHITECTURE.md](../../.dev/ARCHITECTURE.md) -- Open design questions for `action-translation`; Q3 discusses whole-file vs section-by-section translation architecture, and `experiments/forward/` contains initial experiment results that Project A should build on
