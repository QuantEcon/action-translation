...
ഈ lectures-ൽ [Matplotlib](https://matplotlib.org/) ഉപയോഗിച്ച് നമ്മൾ already പല figures-ഉം generate ചെയ്തിട്ടുണ്ട്.

Matplotlib എന്നത്, scientific computing-നായി design ചെയ്തിരിക്കുന്ന ഒരു മികച്ച graphics library ആണ്. അതിൽ ഉള്ളവ:
...
Matplotlib വ്യത്യസ്തമായത് എന്തെന്നാൽ, plotting-ന് ഇത് രണ്ട് വ്യത്യസ്ത interfaces നൽകുന്നു എന്നതാണ്.
...
താഴെ പറയുന്ന കാരണങ്ങൾ കൊണ്ട്, രണ്ടാമത്തെ API ഉപയോഗിക്കാൻ ഞങ്ങൾ recommend ചെയ്യുന്നു.
...
For example, function calls-ൽ, പല objects-ഉം programmer-നെ അറിയിക്കാതെ create ചെയ്യപ്പെടുകയും കൈമാറ്റം ചെയ്യപ്പെടുകയും ചെയ്യുന്നു.

Python programmers സാധാരണയായി കൂടുതൽ വ്യക്തമായ ഒരു programming ശൈലി preference ചെയ്യുന്നു (ഒരു code block-ൽ `import this` run ചെയ്ത്, രണ്ടാമത്തെ line നോക്കുക).

ഇത് നമ്മെ alternative ആയ, object-oriented Matplotlib API-യിലേക്ക് കൊണ്ടുപോകുന്നു.

### The Object-Oriented API

Object-oriented API ഉപയോഗിച്ച്, മുൻപത്തെ figure-ന് corresponding ആയ code താഴെ കാണാം:
...
ഇവിടെ `fig, ax = plt.subplots()` എന്ന call, ഒരു pair return ചെയ്യുന്നു:
...
ഇവിടെ typing കുറച്ചുകൂടി ചെയ്യണം എങ്കിലും, objects കൂടുതൽ വ്യക്തമായി ഉപയോഗിക്കുന്നത് നമുക്ക് better control നൽകുന്നു.
...
Matplotlib-ൽ ധാരാളം functions-ഉം features-ഉം ഉണ്ട്. അവയ്ക്ക് ആവശ്യം വരുമ്പോൾ, കാലക്രമേണ നമുക്ക് അവ കണ്ടെത്താം.
...
താഴെ കൊടുത്തിരിക്കുന്ന example-ൽ, randomly മൂന്ന് normal densities generate ചെയ്യുകയും, അവയുടെ mean-നെ label ചെയ്യുകയും ചെയ്യുന്നു:
...
3D plots-ന്റെ കാര്യത്തിലും Matplotlib നല്ല ജോലി ചെയ്യുന്നു — ഒരു example താഴെ കാണാം:
...
ഒരുപക്ഷേ നിങ്ങൾ പതിവായി ഉപയോഗിക്കുന്ന ഒരു set of customizations കണ്ടെത്തിയേക്കാം.

നമ്മുടെ axes, origin-ൽ കൂടി കടന്നുപോകണം എന്നും, ഒരു grid ഉണ്ടാകണം എന്നും നമുക്ക് സാധാരണയായി ആഗ്രഹമുണ്ട് എന്ന് കരുതുക.
...
1. `fig, ax` pair generate ചെയ്യാൻ, internally standard `plt.subplots` function-നെ call ചെയ്യുന്നു,
1. `ax`-ൽ ആവശ്യമായ customizations ചെയ്യുന്നു, കൂടാതെ
...
Uniform ആയ styles ഉള്ള plots create ചെയ്യാൻ style sheets ഉപയോഗിക്കാം.
...
ഒരു style sheet-ന്റെ name ആർഗ്യുമെന്റ് ആയി എടുത്ത്, ആ style ഉപയോഗിച്ച് വ്യത്യസ്ത plots വരയ്ക്കുന്ന ഒരു function നമുക്ക് എഴുതാം:
...
Plots-ലെ colors remove ചെയ്യാൻ `grayscale` ഉപയോഗിക്കാം:
...
List-ലുള്ള മറ്റ് styles പരീക്ഷിക്കാൻ ഈ function ഉപയോഗിക്കാം.

നിങ്ങൾക്ക് താല്പര്യമുണ്ടെങ്കിൽ, സ്വന്തമായി style sheets പോലും create ചെയ്യാം.

Style sheets-നുള്ള parameters, dictionary പോലെയുള്ള `plt.rcParams` എന്ന variable-ൽ store ചെയ്യപ്പെട്ടിരിക്കുന്നു:
...
Style sheets-ന് വേണ്ടി set ചെയ്യാൻ കഴിയുന്ന ധാരാളം parameters ഉണ്ട്.

Style sheet-നുള്ള parameters set ചെയ്യാൻ:
...
`.rcParams`-ലെ parameters മാറ്റിയതിന് ശേഷം generate ചെയ്യുന്ന ഏത് plot-ഉം, ഈ setting-ന്റെ effect ഉള്ളതായിരിക്കും.
