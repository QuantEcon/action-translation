...
മിക്കവാറും എല്ലാ programming ഭാഷകളും provide ചെയ്യുന്ന വളരെ useful ആയ ഒരു construct ആണ് functions.

* NumPy-യിലെ `sqrt()` function-ഉം
* built-in `print()` function-ഉം

പോലുള്ള പല functions-നെയും നമ്മൾ already പരിചയപ്പെട്ടിട്ടുണ്ട്.
...
Python built-ins-ന്റെ full list [here](https://docs.python.org/3/library/functions.html) കാണാം.


### Third Party Functions

built-in functions നമുക്ക് ആവശ്യമുള്ളത് cover ചെയ്യുന്നില്ലെങ്കിൽ, നമുക്ക് functions import ചെയ്യുകയോ അല്ലെങ്കിൽ സ്വന്തമായി create ചെയ്യുകയോ വേണ്ടിവരും.
...
ഈ function define ചെയ്തു കഴിഞ്ഞു, ഇനി അതിനെ *call* ചെയ്ത് നമ്മൾ പ്രതീക്ഷിക്കുന്നത് പോലെ അത് work ചെയ്യുന്നുണ്ടോ എന്ന് നമുക്ക് check ചെയ്യാം:
...
* `def new_abs_function(x):` എന്നത് function-ന്റെ പേര് `new_abs_function` ആണെന്നും അതിന് `x` എന്ന ഒറ്റ argument ഉണ്ടെന്നും സൂചിപ്പിക്കുന്നു.
...
ആദ്യത്തെ return-ൽ എത്തിച്ചേരുമ്പോൾ function-ന്റെ execution അവസാനിക്കുന്നു, ഇത് താഴെ കൊടുത്തിരിക്കുന്ന example പോലുള്ള code-നെ സാധ്യമാക്കുന്നു
...
(logic പിന്തുടരാൻ ബുദ്ധിമുട്ടാക്കുന്നതിനാൽ, ഒന്നിലധികം return statements ഉള്ള functions എഴുതുന്നത് സാധാരണയായി discourage ചെയ്യപ്പെടുന്നു.)
...
Matplotlib-ന്റെ `plot` function-നെ ഈ call ചെയ്യുമ്പോൾ, അവസാനത്തെ argument `name=argument` syntax-ൽ pass ചെയ്യുന്നത് ശ്രദ്ധിക്കുക.

ഇതിനെ *keyword argument* എന്ന് വിളിക്കുന്നു, `label` ആണ് ഇവിടെ keyword.

keyword അല്ലാത്ത arguments-നെ *positional arguments* എന്ന് വിളിക്കുന്നു, കാരണം അവയുടെ അർത്ഥം order അനുസരിച്ചാണ് നിശ്ചയിക്കുന്നത്
...
താഴെ കൊടുത്തിരിക്കുന്ന വിധത്തിൽ അവയെ modify ചെയ്യാം
...
ഒരു function-നെ മറ്റൊരു function-ലേക്ക് pass ചെയ്യുന്നത് എത്ര എളുപ്പമാണെന്നതിന്റെ examples താഴെ കൊടുത്തിരിക്കുന്ന sections-ൽ നമ്മൾ നൽകും.
...
$\int_0^2 x^3 dx$ കണക്കാക്കണം എന്ന് കരുതുക (നമ്മുടെ high-school calculus മറന്നു എന്നും കരുതുക), അപ്പോൾ `lambda` എന്തുകൊണ്ട് useful ആണ് എന്ന് കാണാം.

ഈ കണക്കുകൂട്ടൽ നമുക്ക് വേണ്ടി ചെയ്യുന്ന `quad` എന്ന function SciPy library-ൽ ഉണ്ട്.

`quad` function-ന്റെ syntax `quad(f, a, b)` എന്നതാണ്, ഇവിടെ `f` ഒരു function ആണ്, `a`, `b` എന്നിവ numbers ആണ്.

$f(x) = x^3$ എന്ന function create ചെയ്യാൻ താഴെ കൊടുത്തിരിക്കുന്ന വിധത്തിൽ `lambda` ഉപയോഗിക്കാം
...
`lambda` create ചെയ്ത function-ന് ഒരിക്കലും പേര് നൽകിയിട്ടില്ലാത്തതിനാൽ അതിനെ *anonymous* എന്ന് വിളിക്കുന്നു.
...
ഇത് താഴെ കൊടുത്തിരിക്കുന്ന program-ൽ സാധിക്കുന്നത് കാണാം
...
ആവശ്യാനുസരണം standard normals-ഓ $(0, 1)$-ൽ ഉള്ള uniform random variables-ഓ return ചെയ്യാനുള്ള കഴിവ് നൽകി അതിനെ കുറച്ചുകൂടി useful ആക്കാം.

ഇത് താഴെ കൊടുത്തിരിക്കുന്ന code piece-ൽ സാധിക്കുന്നത് കാണാം.
...
if/else clause-ന്റെ syntax self-explanatory ആണെന്ന് പ്രതീക്ഷിക്കുന്നു, ഇവിടെയും code blocks-ന്റെ വ്യാപ്തി indentation ആണ് നിശ്ചയിക്കുന്നത്.

Notes

* `U` എന്ന argument നമ്മൾ string ആയാണ് pass ചെയ്യുന്നത്, അതുകൊണ്ടാണ് അതിനെ `'U'` എന്ന് എഴുതുന്നത്.
...
For example, ആവശ്യമുള്ള generator type-നെ ഒരു function, method, അല്ലെങ്കിൽ മറ്റ് [callable](https://typing.python.org/en/latest/spec/callables.html) object ആയി pass ചെയ്ത് conditionals-നെ പൂർണ്ണമായി ഒഴിവാക്കാം.
...
* ഈ lines execute ചെയ്യുന്ന സമയത്ത്, `generator_type`, `rng.uniform` എന്നീ names "synonyms" ആണ്, ഒരേ വിധത്തിൽ ഉപയോഗിക്കാം.

ഈ principle കുറച്ചുകൂടി general ആയി work ചെയ്യുന്നു --- For example, താഴെ കൊടുത്തിരിക്കുന്ന code piece നോക്കാം
...
ഇവിടെ built-in function ആയ `max()`-ന് നമ്മൾ മറ്റൊരു name create ചെയ്തു, അതും ഒരേ വിധത്തിൽ ഉപയോഗിക്കാം.

നമ്മുടെ program-ന്റെ context-ൽ, functions-ലേക്ക്, അല്ലെങ്കിൽ കുറച്ചുകൂടി general ആയി callable objects-ലേക്ക്, names bind ചെയ്യാനുള്ള കഴിവ് അർത്ഥമാക്കുന്നത്, മുകളിൽ `rng.uniform` ഉപയോഗിച്ചത് പോലെ, ഒരു callable object-നെ മറ്റൊരു callable-ലേക്ക് argument ആയി pass ചെയ്യുന്നതിൽ പ്രശ്നമില്ല എന്നാണ്.
...
skip ചെയ്യാൻ മടിക്കേണ്ടതില്ലാത്ത ഒരു advanced topic ആണ് ഇത്.

എന്നാൽ, നിങ്ങളുടെ programming career-ന്റെ ഏതെങ്കിലും stage-ൽ പഠിക്കേണ്ട ഒരു നല്ല idea ആണ് ഇത്.
...
ഈ example കുറച്ച് കൃത്രിമമാണ്, കാരണം recursive solution-നേക്കാൾ സാധാരണയായി ആദ്യത്തെ (iterative) solution ആയിരിക്കും preferred.
