...
ഈ lectures-ൽ [Matplotlib](https://matplotlib.org/) ഉപയോഗിച്ച് നമ്മൾ already നിരവധി figures generate ചെയ്തിട്ടുണ്ട്.

Matplotlib എന്നത്, scientific computing-നായി design ചെയ്തിരിക്കുന്ന ഒരു മികച്ച graphics library ആണ്. ഇതിൽ ഇവ ഉൾപ്പെടുന്നു:
...
Matplotlib വ്യത്യസ്തമായത് എന്തെന്നാൽ, plotting-ന് ഇത് രണ്ട് വ്യത്യസ്ത interfaces provide ചെയ്യുന്നു എന്നതാണ്.

ഇവയിൽ ഒന്ന്, simple MATLAB-style API (Application Programming Interface) ആണ്. MATLAB ഉപയോഗിച്ചിരുന്നവർക്ക് എളുപ്പത്തിൽ ഉപയോഗിക്കാനാകുന്ന തരത്തിലാണ് ഇത് എഴുതിയിരിക്കുന്നത്.

മറ്റൊന്ന്, കൂടുതൽ "Pythonic" ആയ object-oriented API ആണ്.

താഴെ വിശദീകരിക്കുന്ന കാരണങ്ങളാൽ, രണ്ടാമത്തെ API ഉപയോഗിക്കാൻ ഞങ്ങൾ recommend ചെയ്യുന്നു.
...
ഇത് simple-ഉം convenient-ഉം ആണ്, പക്ഷേ ഇതിന് കുറച്ച് പരിമിതികളുണ്ട്. കൂടാതെ ഇത് Python-ന്റെ സാധാരണ ശൈലിയോട് പൊരുത്തപ്പെടാത്തതും ആണ്.

For example, function calls-ൽ, പല objects-ഉം create ചെയ്യപ്പെടുകയും, programmer-നെ അറിയിക്കാതെ തന്നെ അവ കൈമാറ്റം ചെയ്യപ്പെടുകയും ചെയ്യുന്നു.

Python programmers സാധാരണയായി കൂടുതൽ വ്യക്തമായ ഒരു programming ശൈലി preferred ചെയ്യുന്നു (ഒരു code block-ൽ `import this` run ചെയ്ത് രണ്ടാമത്തെ line നോക്കുക).
...
`plot()` function എന്നത്, യഥാർത്ഥത്തിൽ `ax`-ന്റെ ഒരു method ആണ്.

കുറച്ചുകൂടി typing വേണ്ടിവരുമെങ്കിലും, objects കൂടുതൽ വ്യക്തമായി ഉപയോഗിക്കുന്നത്, നമുക്ക് കൂടുതൽ control നൽകുന്നു.

ഇത് കൂടുതൽ വ്യക്തമായി, നമ്മൾ മുന്നോട്ട് പോകുമ്പോൾ കാണാം.
...
Line അല്പം transparent ആയി കാണിക്കാൻ `alpha` ഉപയോഗിച്ചിട്ടുണ്ട് --- ഇത് line-നെ കൂടുതൽ smooth ആയി കാണിക്കുന്നു.
...
Ticks control ചെയ്യുന്നതും, titles ചേർക്കുന്നതും മറ്റും ഒരുപോലെ എളുപ്പം ആണ്:
...
Matplotlib-ന് വളരെയധികം functions-ഉം features-ഉം ഉണ്ട്. ആവശ്യം വരുന്നതനുസരിച്ച് കാലക്രമേണ ഇവയെ നമുക്ക് കണ്ടെത്താം.

ഇവയിൽ കുറച്ച് മാത്രം ഇവിടെ പറയാം.
...
ചിലപ്പോൾ ഒരു figure-ൽ ഒന്നിലധികം subplots വേണമെന്ന് വരും.
...
Matplotlib, 3D plots-ന്റെ കാര്യത്തിലും വളരെ നന്നായി work ചെയ്യുന്നു --- അതിന്റെ ഒരു example താഴെ കാണാം:
...
ഒരുപക്ഷേ നിങ്ങൾ പതിവായി ഉപയോഗിക്കുന്ന ഒരു കൂട്ടം customizations നിങ്ങൾക്ക് കണ്ടെത്താൻ സാധിച്ചേക്കാം.

നമ്മുടെ axes, origin-ൽ കൂടി കടന്നുപോകാനും, ഒരു grid ഉണ്ടാകാനും നമ്മൾ സാധാരണയായി preferred ചെയ്യുന്നു എന്ന് കരുതുക.
...
ഒരു style sheet-ന്റെ name argument ആയി എടുത്ത്, ആ style ഉപയോഗിച്ച് വ്യത്യസ്ത plots വരയ്ക്കുന്ന ഒരു function നമുക്ക് എഴുതാം:
...
ഈ styles-ൽ ചിലത് എങ്ങനെയുണ്ടെന്ന് നമുക്ക് നോക്കാം.
...
താല്പര്യമുണ്ടെങ്കിൽ, നിങ്ങൾക്ക് സ്വന്തമായി style sheets create ചെയ്യാൻ പോലും സാധിക്കും.
...
നിങ്ങളുടെ style sheets-ന് വേണ്ടി set ചെയ്യാവുന്ന നിരവധി parameters ഉണ്ട്.
...
`.rcParams`-ലെ parameters മാറ്റിയതിന് ശേഷം generate ചെയ്യുന്ന ഏത് plot-ഉം, ഈ setting-നാൽ affect ചെയ്യപ്പെടും.
...
നിങ്ങളുടെ style-നെ വീണ്ടും default ആക്കി മാറ്റാൻ, `default` എന്ന style sheet ഒരിക്കൽ കൂടി apply ചെയ്യുക:
