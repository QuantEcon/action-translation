...
Matplotlib എന്നത്, scientific computing-നായി design ചെയ്തിരിക്കുന്ന ഒരു മികച്ച graphics library ആണ്. ഇതിൽ:

* high-quality 2D, 3D plots ഉണ്ട്
...
* animation മുതലായവയും ഉണ്ട്

### Matplotlib's Split Personality

Matplotlib വ്യത്യസ്തമായത്, plotting-നായി രണ്ട് വ്യത്യസ്ത interfaces provide ചെയ്യുന്നു എന്നതിലാണ്.

ഒന്ന്, ലളിതമായ ഒരു MATLAB-style API (Application Programming Interface) ആണ്. MATLAB ഉപയോഗിച്ചിരുന്നവർക്ക് എളുപ്പത്തിൽ ഉപയോഗിക്കാനാകുന്ന തരത്തിലാണ് ഇത് എഴുതിയിരിക്കുന്നത്.
...
Introductory treatments-ൽ കാണാവുന്ന തരത്തിലുള്ള ഒരു ലളിതമായ example താഴെ കാണാം
...
For example, function calls-ൽ ധാരാളം objects create ചെയ്യപ്പെടുകയും, programmer-നെ അറിയിക്കാതെതന്നെ അവ പാസ് ചെയ്യപ്പെടുകയും ചെയ്യുന്നു.

Python programmers സാധാരണയായി കൂടുതൽ വ്യക്തമായ ഒരു programming ശൈലി ഇഷ്ടപ്പെടുന്നു (ഒരു code block-ൽ `import this` run ചെയ്ത് രണ്ടാമത്തെ വരി നോക്കുക).

ഇത് നമ്മളെ alternative ആയ, object-oriented Matplotlib API-യിലേക്ക് നയിക്കുന്നു.

### The Object-Oriented API

Object-oriented API ഉപയോഗിച്ച് മുമ്പത്തെ figure-ന് അനുയോജ്യമായ code താഴെ കാണാം
...
അല്പം കൂടുതൽ typing വേണ്ടിവരുമെങ്കിലും, objects കൂടുതൽ വ്യക്തമായി ഉപയോഗിക്കുന്നത് നമുക്ക് മെച്ചപ്പെട്ട control നൽകുന്നു.
...
Ticks control ചെയ്യുന്നതും, titles ചേർക്കുന്നതും മറ്റും എളുപ്പം തന്നെ
...
Matplotlib-ന് ധാരാളം functions-ഉം features-ഉം ഉണ്ട്. ആവശ്യം വരുന്ന മുറയ്ക്ക് കാലക്രമേണ ഇവയെക്കുറിച്ച് നമുക്ക് കൂടുതൽ അറിയാം.

ഇവയിൽ ചിലത് മാത്രം ഇവിടെ പറയാം.
...
ചിലപ്പോൾ ഒരൊറ്റ figure-ൽ ഒന്നിലധികം subplots വേണ്ടിവരും.
...
നിങ്ങൾ പതിവായി ഉപയോഗിക്കുന്ന ഒരു കൂട്ടം customizations ഒരുപക്ഷേ നിങ്ങൾക്ക് കണ്ടെത്താൻ കഴിഞ്ഞേക്കാം.

നമ്മുടെ axes, origin-ലൂടെ കടന്നുപോകണമെന്നും, ഒരു grid ഉണ്ടായിരിക്കണമെന്നും നമ്മൾ സാധാരണ ഇഷ്ടപ്പെടുന്നു എന്ന് കരുതുക.
...
1. `ax`-ൽ ആവശ്യമായ customizations വരുത്തുന്നു, കൂടാതെ
...
ഒരു style sheet-ന്റെ name സ്വീകരിച്ച്, ആ style ഉപയോഗിച്ച് വ്യത്യസ്തമായ plots draw ചെയ്യുന്ന ഒരു function നമുക്ക് എഴുതാം
...
താൽപ്പര്യമുണ്ടെങ്കിൽ, നിങ്ങളുടെ സ്വന്തം style sheets പോലും create ചെയ്യാം.
...
നിങ്ങളുടെ style sheets-ന് നിങ്ങൾക്ക് set ചെയ്യാവുന്ന ധാരാളം parameters ഉണ്ട്.
