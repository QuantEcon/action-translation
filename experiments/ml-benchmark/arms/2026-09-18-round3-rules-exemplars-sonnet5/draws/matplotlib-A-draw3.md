...
Matplotlib ഒരു outstanding graphics library ആണ്, scientific computing-ന് വേണ്ടി design ചെയ്തത്, ഇതിൽ ഉള്ളവ:

* high-quality 2D, 3D plots
* PDF, PNG തുടങ്ങിയ usual formats-ലെ output
* LaTeX integration
...
Matplotlib-ന് plotting-നായി രണ്ട് വ്യത്യസ്ത interfaces ഉണ്ട് എന്നത് ഇതിനെ വ്യത്യസ്തമാക്കുന്നു.

ഒന്ന്, ലളിതമായ MATLAB-style API (Application Programming Interface) ആണ്. MATLAB-ൽ നിന്നും വരുന്നവർക്ക് പെട്ടെന്ന് പരിചയപ്പെടാൻ വേണ്ടിയാണ് ഇത് എഴുതിയത്.

മറ്റേത് കുറച്ചുകൂടി "Pythonic" ആയ object-oriented API ആണ്.
...
ഇത് ലളിതവും convenient-ഉം ആണ്, പക്ഷേ ഇതിന് ചില പരിമിതികളുണ്ട്, ഒപ്പം un-Pythonic ആണ്.

For example, function calls-ൽ ധാരാളം objects create ചെയ്യപ്പെടുകയും programmer അറിയാതെ pass ചെയ്യപ്പെടുകയും ചെയ്യുന്നു.

Python programmers സാധാരണയായി കുറച്ചുകൂടി explicit ആയ programming style ആണ് preference ചെയ്യുന്നത് (ഒരു code block-ൽ `import this` run ചെയ്ത് രണ്ടാമത്തെ line നോക്കുക).

ഇത് നമ്മളെ alternative ആയ, object-oriented Matplotlib API-ലേക്ക് നയിക്കുന്നു.

### The Object-Oriented API

മുകളിലെ figure-ന് സമാനമായ code, object-oriented API ഉപയോഗിച്ച് താഴെ കാണാം:
...
കുറച്ചുകൂടി typing വേണ്ടിവരുമെങ്കിലും, objects-ന്റെ ഈ explicit ആയ ഉപയോഗം നമുക്ക് better control നൽകുന്നു.

നമ്മൾ മുന്നോട്ട് പോകുമ്പോൾ ഇത് കൂടുതൽ വ്യക്തമാകും.

### Tweaks

ഇവിടെ നമ്മൾ line-ന്റെ നിറം red ആക്കി ഒരു legend-ഉം ചേർത്തിരിക്കുന്നു:
...
Line അല്പം transparent ആക്കാൻ നമ്മൾ `alpha`-യും ഉപയോഗിച്ചിട്ടുണ്ട്---ഇത് കൂടുതൽ smooth ആയി കാണിക്കുന്നു.
...
Ticks control ചെയ്യുന്നതും titles ചേർക്കുന്നതും മറ്റും അതുപോലെ എളുപ്പം ആണ്:
...
Matplotlib-ന് വളരെ വലിയ ഒരു functions, features ശേഖരം ഉണ്ട്, ആവശ്യം വരുമ്പോൾ കാലക്രമേണ അവയെ നമുക്ക് discover ചെയ്യാം.

ഇവിടെ കുറച്ച് matters മാത്രം പറയാം.
...
മൂന്ന് normal densities randomly generate ചെയ്ത് അവയുടെ mean-ഉം കൂടെ label ചെയ്യുന്ന ഒരു example താഴെ കാണാം:
...
Matplotlib 3D plots വളരെ നന്നായി ചെയ്യുന്നു --- ഒരു example ഇതാ:
...
ഒരുപക്ഷേ നിങ്ങൾ പതിവായി ഉപയോഗിക്കുന്ന customizations-ന്റെ ഒരു set നിങ്ങൾ കണ്ടെത്തിയേക്കാം.

നമ്മുടെ axes origin-ലൂടെ പോകണം എന്നും ഒരു grid ഉണ്ടാകണം എന്നും നമ്മൾ സാധാരണ preference ചെയ്യുന്നു എന്ന് കരുതുക.

ഈ changes implement ചെയ്യുന്ന ഒരു custom `subplots` function build ചെയ്യാൻ object-oriented API എങ്ങനെ ഉപയോഗിക്കാം എന്നതിന്റെ [Matthew Doty](https://github.com/xcthulhu)-യുടെ നല്ലൊരു example താഴെ കാണാം.

Code ശ്രദ്ധയോടെ വായിച്ച്, എന്താണ് നടക്കുന്നത് എന്ന് നിങ്ങൾക്ക് follow ചെയ്യാൻ പറ്റുമോ എന്ന് നോക്കുക:
...
1. `ax`-ൽ ആവശ്യമുള്ള customizations ചെയ്യുന്നു, ഒപ്പം
1. `fig, ax` pair-നെ calling code-ലേക്ക് തിരികെ pass ചെയ്യുന്നു.

### Style Sheets

Matplotlib-ലെ മറ്റൊരു useful ആയ feature ആണ് [style sheets](https://matplotlib.org/stable/gallery/style_sheets/style_sheets_reference.html).
...
Listലുള്ള മറ്റ് styles experiment ചെയ്യാൻ ഈ function ഉപയോഗിക്കാം.

Interest ഉണ്ടെങ്കിൽ, നിങ്ങൾക്ക് സ്വന്തമായി style sheets പോലും create ചെയ്യാം.

നിങ്ങളുടെ style sheets-നുള്ള parameters, dictionary പോലുള്ള `plt.rcParams` എന്ന variable-ൽ store ചെയ്യപ്പെടുന്നു:
...
നിങ്ങളുടെ style sheets-ന് set ചെയ്യാൻ പറ്റുന്ന ധാരാളം parameters ഉണ്ട്.

നിങ്ങളുടെ style sheet-ന് parameters set ചെയ്യാൻ:

1. സ്വന്തമായി [`matplotlibrc` file](https://matplotlib.org/stable/users/explain/customizing.html) create ചെയ്യുക, അല്ലെങ്കിൽ
2. dictionary പോലുള്ള `plt.rcParams` എന്ന variable-ൽ store ചെയ്ത values update ചെയ്യുക

രണ്ടാമത്തെ method ഉപയോഗിച്ച് overlaid ആയ density lines-ന്റെ style നമുക്ക് മാറ്റാം:
...
`.rcParams`-ലെ parameters മാറ്റിയ ശേഷം generate ചെയ്യുന്ന ഏത് plot-നെയും ഈ setting ബാധിക്കും.
...
നിങ്ങളുടെ style default-ലേക്ക് തിരികെ മാറ്റാൻ `default` style sheet വീണ്ടും apply ചെയ്യുക:
...
* Nicolas Rougier, Mike Muller, Gael Varoquaux എന്നിവരുടെ നല്ലൊരു [Matplotlib tutorial](https://scipy-lectures.org/intro/matplotlib/index.html).
* [mpltools](https://tonysyu.github.io/mpltools/index.html) plot styles-ക്കിടയിൽ എളുപ്പത്തിൽ switch ചെയ്യാൻ അനുവദിക്കുന്നു.
