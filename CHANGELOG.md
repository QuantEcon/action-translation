...
- **ml round-3 regeneration arm archived** under `experiments/ml-benchmark/arms/2026-09-18-round3-rules-exemplars-sonnet5/`: a 2 × 2 (rules payload × held-out style examples), three draws per cell, scored against the editor's reviewed `matplotlib`. `ml_metrics.py` gains the round-3 banned renderings. Experiment data only.
