...
exports.resolveFilePairs = resolveFilePairs;
exports.applyExcludes = applyExcludes;
exports.checkFileStatus = checkFileStatus;
exports.runStatus = runStatus;
exports.formatStatusTable = formatStatusTable;
 ...
 */
function discoverMarkdownFiles(repoPath, docsFolder) {
 ...
 */
function resolveFilePairs(sourceFiles, targetFiles) {
...
function formatStatusTable(result) {
    ...
    lines.push('');
    // Per-file table
    const maxFileLen = Math.max(4, // "File" header
