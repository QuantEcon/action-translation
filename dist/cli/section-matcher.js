...
exports.validateMatchesWithHeadingMap = validateMatchesWithHeadingMap;
exports.getMatchingSummary = getMatchingSummary;
/**
 ...
 */
function validateMatchesWithHeadingMap(pairs, headingMap) {
    const warnings = [];
    for (const pair of pairs) {
        ...
        if (expectedTranslation) {
            ...
            if (expectedTranslation !== targetHeadingText) {
                warnings.push(`Position ${pairs.indexOf(pair)}: heading-map expected "${expectedTranslation}" ` +
 ...
 */
function getMatchingSummary(pairs) {
    let matched = 0;
    let sourceOnly = 0;
    let targetOnly = 0;
    for (const pair of pairs) {
...
//# sourceMappingURL=section-matcher.js.map